...
class UserAndAuthenticationApi {
  ...
  const UserAndAuthenticationApi(this._dio);

  /// createUser
  /// Register a new user
  ///
  /// Parameters:
  /// * [body] - Details of the new user to register
  ...
  Future<Response<Login200Response>> createUser({ 
...
_responseData = rawData == null ? null : deserialize<Login200Response, Login200Response>(rawData, 'Login200Response', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Returns a [Future] containing a [Response] with a [Login200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Login200Response>> getCurrentUser({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
...
_responseData = rawData == null ? null : deserialize<Login200Response, Login200Response>(rawData, 'Login200Response', growable: true);
  ...
  ///
  /// Parameters:
  /// * [body] - User details to update. At least **one** field is required.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [Login200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Login200Response>> updateCurrentUser({ 
    required UpdateCurrentUserRequest body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
