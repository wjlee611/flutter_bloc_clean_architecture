...
import 'package:openapi/src/api/articles_api.dart';
import 'package:openapi/src/api/comments_api.dart';
import 'package:openapi/src/api/favorites_api.dart';
import 'package:openapi/src/api/profile_api.dart';
import 'package:openapi/src/api/tags_api.dart';
import 'package:openapi/src/api/user_and_authentication_api.dart';

class Openapi {
  static const String basePath = r'https://api.realworld.io/api';
  ...
  ArticlesApi getArticlesApi() {
    return ArticlesApi(dio);
  }
  ...
  UserAndAuthenticationApi getUserAndAuthenticationApi() {
    return UserAndAuthenticationApi(dio);
  }
}
